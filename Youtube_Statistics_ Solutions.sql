...
Explore the relationship between a video's popularity and its most liked or relevant comments.
You'll work with video-level statistics and user-generated comments, including sentiment analysis.
This project gives you a chance to connect engagement metrics with audience reactions using SQL.

Your goal is to uncover what kinds of videos drive more engagement,
what comment patterns appear for high-performing videos, 
and how sentiment relates to popularity.
